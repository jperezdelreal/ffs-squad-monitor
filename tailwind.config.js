  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'depth-surface-light': '0 1px 3px rgba(0, 0, 0, 0.05), 0 1px 2px rgba(0, 0, 0, 0.10)',
        'depth-raised-light': '0 4px 6px rgba(0, 0, 0, 0.07), 0 2px 4px rgba(0, 0, 0, 0.12)',
        'depth-floating-light': '0 10px 20px rgba(0, 0, 0, 0.10), 0 6px 6px rgba(0, 0, 0, 0.15)',

        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-lg text-sm font-medium hover:shadow-glow-cyan transition-all flex items-center gap-2"
            >
        ...
        <AnimatePresence mode="popLayout">
          {[...agents].sort((a, b) => {
            ...
            <motion.div
              ...
              transition={springPresets.default}
              className={`glass depth-raised rounded-xl p-5 border ${
                blocked
                  ? 'border-red-500/30 hover:border-red-500/50 hover:shadow-glow-blue-sm'
                  : agent.status === 'active' 
                    ? 'border-emerald-500/30 hover:border-emerald-500/50 hover:shadow-depth-floating' 
                    : 'border-white/10 hover:border-white/20 hover:shadow-depth-raised'
              }`}
            >
